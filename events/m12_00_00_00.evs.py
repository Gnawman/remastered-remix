...
def Constructor():
    ...
    RunEvent(11200801)
    RunEvent(11205300, slot=0, args=(1, 0, 0, 3530, 3530, 139, 79, 91), arg_types="hhiiiBBi")
    RunEvent(11205300, slot=1, args=(2, 0, 0, 3531, 3531, 140, 79, 92), arg_types="hhiiiBBi")
    RunEvent(11205300, slot=2, args=(3, 0, 0, 3532, 3532, 141, 79, 93), arg_types="hhiiiBBi")
    RunEvent(11205300, slot=3, args=(4, 0, 0, 3533, 3533, 142, 79, 94), arg_types="hhiiiBBi")
    RunEvent(11205300, slot=4, args=(5, 0, 0, 3534, 3534, 143, 79, 95), arg_types="hhiiiBBi")
    RunEvent(11205300, slot=5, args=(6, 0, 0, 3535, 3535, 144, 79, 96), arg_types="hhiiiBBi")
    RunEvent(11205300, slot=6, args=(8, 0, 0, 3536, 3536, 145, 79, 97), arg_types="hhiiiBBi")
