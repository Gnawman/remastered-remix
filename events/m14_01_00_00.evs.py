...
def Event11415200():
    """Event 11415200"""
    RunEvent(11415201, slot=0, args=(1410500, 1, 0, 0, 3290), arg_types="ihhii")
    ...
    RunEvent(11415201, slot=1, args=(1410500, 2, 0, 0, 3291), arg_types="ihhii")
    ...
    RunEvent(11415201, slot=2, args=(1410500, 3, 0, 0, 3292), arg_types="ihhii")
    ...
    RunEvent(11415201, slot=3, args=(1410500, 4, 0, 0, 3293), arg_types="ihhii")
