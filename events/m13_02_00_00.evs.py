...
def Event11320110():
    ...
    RunEvent(11325121)
    RunEvent(11325110, slot=0, args=(1, 0, 0, 3530, 3530, 253, 38, 91), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=1, args=(2, 0, 0, 3531, 3531, 254, 38, 92), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=2, args=(3, 0, 0, 3532, 3532, 255, 38, 93), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=3, args=(4, 0, 0, 3533, 3533, 0, 39, 94), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=4, args=(5, 0, 0, 3534, 3534, 1, 39, 95), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=5, args=(6, 0, 0, 3535, 3535, 2, 39, 96), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=6, args=(8, 0, 0, 3536, 3536, 3, 39, 97), arg_types="hhiiiBBi")
